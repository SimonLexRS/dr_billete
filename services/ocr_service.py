"""
Servicio OCR usando la API de DeepSeek (compatible con OpenAI).
...
class OCRService:
    ...
    def extract_from_image(self, image_base64: str) -> dict:
        """
        Envia una imagen en base64 a DeepSeek para extraer datos del billete.
...
y puede tener un prefijo de letras seguido de numeros."""
    ...
    def test_connection(self) -> dict:
        """Prueba la conexion con la API de DeepSeek."""
        headers = {
            "Authorization": f"Bearer {self.api_key}",
            "Content-Type": "application/json",
        }
